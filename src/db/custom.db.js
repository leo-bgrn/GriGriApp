...
const getHistoricWithUsersNameQuery =
  "SELECT users.name, grigri_location.from, grigri_location.to FROM grigri_location INNER JOIN users ON grigri_location.user = users.id ORDER BY grigri_location.from DESC";
